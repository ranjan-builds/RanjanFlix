    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center max-w-md mx-auto px-4">
          <div className="border border-red-200 rounded-xl p-6 bg-red-50 dark:bg-red-900/20">
          ...
          <NavLink
            to="/"
            className="inline-flex items-center gap-2 mt-6 px-6 py-3 rounded-lg bg-gray-900 hover:bg-gray-800 text-white transition-colors"
          >
            <GoArrowLeft />
            Return to Home
          </NavLink>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-950">
        <div className="text-center">
          ...
          <NavLink
            to="/"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-gray-900 hover:bg-gray-800 text-white transition-colors"
          >
            <GoArrowLeft />
            Back to Home
          </NavLink>
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50">
        <div className="container mx-auto px-4 py-8">
          ...
          <NavLink
            to="/"
            className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-gray-700 dark:text-gray-300"
          >
            <GoArrowLeft />
            Back to Home
          </NavLink>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[280px_auto] gap-8 items-start">
            ...
            <div className="flex justify-center lg:justify-start">
              <div className="relative">
                <img
                  className="w-64 h-96 rounded-xl shadow-lg object-cover border border-gray-200 dark:border-gray-700"
                    ...
                    <div className="px-6 pb-6">
                      {trailerLoading ? (
                        <div className="flex items-center justify-center h-48 bg-gray-100 dark:bg-gray-800 rounded-lg">
                          ...
                          <span className="ml-3">Loading trailer...</span>
                        </div>
                      ) : selectedTrailer ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-48 bg-gray-100 dark:bg-gray-800 rounded-lg gap-3">
                          <GoAlert className="text-3xl text-gray-400" />
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-blue-100 dark:bg-blue-900 rounded-lg">
                <GoDeviceCameraVideo className="text-blue-600 dark:text-blue-400" />
              </div>
              <div>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-green-100 dark:bg-green-900 rounded-lg">
                <GoClock className="text-green-600 dark:text-green-400" />
              </div>
              <div>
                <p className="text-lg font-semibold text-gray-900 dark:text-white">
                  {convertMinutesToTime(totalRuntime)}
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-purple-100 dark:bg-purple-900 rounded-lg">
                <GoCalendar className="text-purple-600 dark:text-purple-400" />
              </div>
              <div>
                <p className="text-lg font-semibold text-gray-900 dark:text-white">
                  {getReleaseYears()}
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-yellow-100 dark:bg-yellow-900 rounded-lg">
                <GoStar className="text-yellow-600 dark:text-yellow-400" />
              </div>
              <div>
                <p className="text-lg font-semibold text-gray-900 dark:text-white">
                  {averageRating}
