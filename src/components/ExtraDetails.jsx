...
const ExtraDetails = ({ movie, Bg, textColor1, movieKeywords }) => {
  const handleRedirect = (server) => {
    ...
    switch (server) {
      case 1:
        url = `https://bollyflix.frl/search/${formattedTitle}`;
        break;
      case 2:
        url = `https://1filmyfly.top/site-1.html?to-search=${formattedTitle}`;
        break;
      case 3:
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      style={{
        background: `linear-gradient(to top, transparent, ${Bg})`,
        color: textColor1,
      }}
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <InfoBlock
            ...
            value={
              movie.revenue ? formatCurrency(movie.revenue) : "In Progress"
            }
          />
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <ServerButton name="Google" onClick={() => handleRedirect(3)} />
          </div>
        </div>
